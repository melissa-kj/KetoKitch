          ...
          <h1>{this.props.faveRecipe.title}</h1>
            <cite className="contributors">
              ...
              <ul id="recipe_meta_data" className="list-group">
                <li className="list-group-item">Active prep: {this.props.faveRecipe.activePrep}</li>
                <li className="list-group-item">Total prep: {this.props.faveRecipe.totalPrep}</li>
