...
public class CommentController {
    ...
    public Comment createComment(@RequestBody Comment newComment, @PathVariable Long recipeId, String username) {
        return commentService.createComment(newComment, recipeId, username);
    }
